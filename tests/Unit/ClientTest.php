...
class ClientTest extends TestCase
{
    ...
    public function testGenerativeModelWithEnumModelName()
    {
        $client = new Client(
            'test-api-key',
            $this->createMock(HttpClientInterface::class),
    ...
    public function testEmbeddingModelWithEnumModelName()
    {
        $client = new Client(
            'test-api-key',
            $this->createMock(HttpClientInterface::class),
    ...
    public function testGenerateContentWithEnumModelName(): void
    {
        $httpRequest = new Request(
            'POST',
            'https://generativelanguage.googleapis.com/v1/models/gemini-pro:generateContent',
    ...
    public function testCountTokensWithEnumModelName(): void
    {
        $httpRequest = new Request(
            'POST',
            'https://generativelanguage.googleapis.com/v1/models/gemini-pro:countTokens',
